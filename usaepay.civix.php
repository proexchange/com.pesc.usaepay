 ...
 * missing them.
 */
function _usaepay_civix_fixNavigationMenu(&$nodes) {
  $maxNavID = 1;
  ...
  _usaepay_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _usaepay_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
